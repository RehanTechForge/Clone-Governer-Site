...
const Footer = () => {
  return (
    <div className="mt-20 w-full bg-zinc-100 print:hidden">
      <div className="m-auto w-[95%] py-20 lg:w-[90%]">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
          ...
          <div className="text-zinc-800">
            ...
            <div className="my-5 flex gap-3 md:text-sm">
              ...
              <a
                target="_blank"
                className="flex h-8 w-8 items-center justify-center rounded-full text-white bg-gradient-to-r from-pink-500 to-purple-500" // Gradient background
            ...
            <a
              className="mt-4 flex items-center py-1 text-main underline text-[#014d82]"
              target="_blank"
